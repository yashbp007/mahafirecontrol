    ...
    <section class="section-padding">
      <div class="container">
        <div style="display: flex; flex-wrap: wrap; align-items: flex-start; gap: 50px;">
          ...
          <!-- Logo Container -->
          <div style="flex: 1; min-width: 280px; position: sticky; top: 100px;" class="animate-on-scroll slide-right">
          ...
          <!-- Text Content -->
          <div style="flex: 1.5; min-width: 300px;" class="animate-on-scroll slide-left stagger-1">
