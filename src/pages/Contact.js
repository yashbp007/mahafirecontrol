export function Contact() {
  return `
    <!-- Hero Banner -->
    <section class="hero-banner" style="background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.8)), url('/assets/s5.jpeg') center/cover; text-align: center; color: white;">
      <div class="container">
